...
public class EmployeePage {
    ...
    private By empId = By.xpath("//div[@class='oxd-input-group oxd-input-field-bottom-space']//input[@class='oxd-input oxd-input--active']");
    private By saveBtn = By.xpath("//button[@type='submit']");
    private By searchBox = By.xpath("//label[text()='Employee Id']/following::div//input[@class='oxd-input oxd-input--active']");
    private By searchBtn = By.xpath("//button[@type='submit']");
    private By job = By.xpath("//a[text()='Job']");
    private By jobTitleDropDown = By.xpath("//div[label[text()='Job Title']]/following-sibling::div//div//div[@class='oxd-select-text oxd-select-text--active']");
    private By empStatus = By.xpath("//div[label[text()='Employment Status']]/following-sibling::div//div//div[@class='oxd-select-text oxd-select-text--active']");
    ...
    public void addEmployee(String fName, String lName, String id) {
        try {
            ...
            String shot = ScreenshotUtil.captureScreenshot(driver, "AddEmployee");
            SeleniumReportUtil.logPass("Employee added successfully", shot);
        } catch (Exception e) {
    ...
    public void editEmployee(String newJobTitle, String newStatus) {
        try {
            ...
            WebElement statusOption = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//div[@role='option' and normalize-space()='" + newStatus + "']")));
    ...
    public void deleteEmployee(String id) {
        try {
            ...
            WebElement firstCheckbox = wait.until(ExpectedConditions.presenceOfElementLocated(
                By.xpath("(//span[contains(@class,'oxd-checkbox-input')]/i[contains(@class,'oxd-checkbox-input-icon')])[1]")));
            ...
            WebElement confirmDeleteBtnElement = wait.until(ExpectedConditions.presenceOfElementLocated(confirmDeleteBtn));
